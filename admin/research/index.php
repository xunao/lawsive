...
<head>
	...
	?>
	<title><?php echo $_g_site_name;?>-调查报告管理</title>
	<?php
		css_include_tag('admin/base');
		use_jquery();
		js_include_tag('category','jquery.colorbox','admin/news/index');
...
<div id=itable>
	<table cellspacing="1" align="center">
		...
		<tr class=tr3 id=<?php echo $record[$i]->id;?> >
			<td style="text-align:left; text-indent:12px;"><a href="<?php echo "/research/research.php?id={$record[$i]->id}";?>" target="_blank"><?php echo strip_tags($record[$i]->title);?></a></td>
