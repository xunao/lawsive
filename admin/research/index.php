...
<div id=itable>
	<table cellspacing="1" align="center">
		...
		<tr class=tr3 id=<?php echo $report[$i]->id;?> >
			<td style="text-align:left; text-indent:12px;"><a href="/news/research&report/research.php?id=<?php echo $report[$i]->id;?>" target="_blank"><?php echo strip_tags($report[$i]->title);?></a></td>
