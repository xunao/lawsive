...
<head>
	...
	<?php
		...
		use_jquery();
		js_include_tag('admin/menu/index','admin/pub');
	?>
</head>
<body>
	<div id=icaption>
	...
	<div id="itable">
		...
		?>
				<tr class="tr3" id=<?php echo $record[$i]->id;?> >
					...
					<?php } ?>
					<td><a href="edit.php?parent_id=<?php echo $record[$i]->id;?>" title="添加子菜单"><img src="/images/admin/btn_add.png" border="0"></a>　<a href="edit.php?id=<?php echo $record[$i]->id;?>&type=<?php echo $type?>" target="admin_iframe" title="编辑"><img src="/images/admin/btn_edit.png" border="0"></a>　<a class="del" name="<?php echo $record[$i]->id;?>" style="color:#ff0000; cursor:pointer" title="删除"><img src="/images/admin/btn_delete.png" border="0"></a></td>
				</tr>
				<?php
				//----------
		...
		?>
		<tr class=btools>
			<td colspan="10"><button id="edit_priority">编辑优先级</button> <button id="clear_priority">清空优先级</button>　		<input type="hidden" id="db_table" value="admin_menu"></td>
		</tr>
	</table>
	</div>
</body>
