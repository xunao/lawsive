...
<div id=itable>
	<table cellspacing="1" align="center">
		<tr class=itable_title>
			<td width="25%">标题</td><td width="20%">作者</td><td width="20%">报告文件名</td><td width="20%">发布时间</td><td width="15%">操作</td>
		</tr>
		<?php
			//--------------------
		...
		<tr class=tr3 id=<?php echo $report[$i]->id;?> >
			<td style="text-align:left; text-indent:12px;"><a href="/news/research&report/report.php?id=<?php echo $report[$i]->id;?>" target="_blank"><?php echo strip_tags($report[$i]->title);?></a></td>
