...
<head>
	...
	<title><?php echo $_g_sitename;?>推荐律所管理</title>
	<?php 
		judge_admin();
		css_include_tag('admin/base','colorbox');
		use_jquery_ui();
		#validate_form("news_edit");
		js_include_tag('category','jquery.colorbox','admin/office/lawfirm/edit','pubfun');
		use_ckeditor();
		$plug=new Table('plug');
		$id = intval($_GET['id']);
		if($id){
...
<!--			</tr>-->
			...
			<tr class="btools">
				<td colspan="2">
					...
					<input type="hidden" name="news[resource_type]" value="lawfirm" />
