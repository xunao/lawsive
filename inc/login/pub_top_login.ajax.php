<?php 
	...
	<div class="t_l_r_ccccc" id="tr">欢迎您，<?php if($user->name != ''){echo $user->name;}else{echo $user->login_name;} ;?></div>
	<?php 	
	}
