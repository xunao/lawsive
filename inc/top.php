<div id="title">
                    ...
                    <div id="title_log">
                              ...
                              <?php if($user == ''){?>
                              <div id="t_l_r">
			                                 <div class="t_l_r_c" >用户名：</div><div class="t_l_r_c"><input id="name0" type="text" name="name0" size=10/></div>
			                                 <div class="t_l_r_c" >密码：</div><div class="t_l_r_c"><input id="password0" type="password" name="password0"/></div>
