<style>
	...
	#right_tab #tab_left .tab1{width:84px; height:19px; margin-bottom:1px; text-align:center; color:#666666; background:url(/images/right/right_tab2.jpg) no-repeat; overflow:hidden;}
	#right_tab #tab_left .tab1.select{height:20px; color:#003869; font-weight:bold; background:url(/images/right/right_tab1.jpg) no-repeat;}
