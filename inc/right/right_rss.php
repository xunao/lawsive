<style>
	#right_rss{width:355px; height:40px; margin:10px 0; border:1px solid #8EAFC7}
	#right_rss_in{width:350px; height:35px; background:#BDD8EB; margin:2.5px; }
	#right_rss_in img{float:left; }
	#right_rss_in input{line-height:22px; }
