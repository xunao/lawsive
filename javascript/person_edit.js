...
$(function(){
	...
	$(".edu_edit").click(function(e){
		e.preventDefault();
		$.fn.colorbox({'href':'/admin/member/education_edit.php?id=' +$('#id').val()+ '&type=edit&e_id=' +$(this).attr('name')+ '&num=' +$(this).attr('value')+ ''});
	});
	$("#edu_add").click(function(e){
		e.preventDefault();
		$.fn.colorbox({'href':'/admin/member/education_edit.php?id=' +$('#id').val()+ '&type=add'});
	});
	$(".job_edit").click(function(e){
		e.preventDefault();
		$.fn.colorbox({'href':'/admin/member/job_edit.php?id=' +$('#id').val()+'&type=edit&j_id=' +$(this).attr('name')+ '&num=' +$(this).attr('value')+ ''});
	});
	$("#job_add").click(function(e){
		e.preventDefault();
		$.fn.colorbox({'href':'/admin/member/job_edit.php?id=' +$('#id').val()+ '&type=add'});
	});
