...
<body>
      <div id="ibody">
      	<?php include_once(dirname(__FILE__).'/../inc/person_top.php'); ?>
      	<div id="person_index_welcome">
      		<div id="content">欢迎律氏用户中心，您将在这里收获意外</div>
      		<div id="close"></div>
      	</div>
      	...
      	<div id="person_index_left">
      		...
      		<?php for($i=0;$i<10; $i++){ ?>
      		<div class="content"><a href="">职业生涯(new)</a></div>
      		<?php }?>
      	...
      	<?php include_once(dirname(__FILE__).'/../inc/person_bottom.php'); ?>
      </div>
</body>
</html>