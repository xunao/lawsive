...
<?php	
		...
		js_include_tag('login','diary','comment','home/office/office');
		use_ckeditor();
		$user = member::current();
		if(!$user)
		{
      ...
      <div id="ibody">
      	...
      	<div id="diary_box">
      		<div id="diary_title">
      			...
      			<?php if($user->id == $article->member_id){?>我的律师&律所推荐
      			<?php }else{ 
      				echo $article->author;
      			?>的日志展示
      			<?php }?>
      			<div id="e_ret">
	      			<a href="/home/office/">
		      			<?php if($user->id == $article->member_id){?>&gt;&gt;返回我的律师&律所推荐首页
		      			<?php }else{ 
      		...
      		<div id="com">
      			...
      			<div id="com_author">作者：<a href="/home/index.php?id=<?php echo $article->member_id;?>"><?php echo $article->member_name;?></a>　　创建时间：<font><?php echo mb_substr($article->created_at, 0,16);?></font></div>
      		</div>
<!--      		<div id="comment">-->
