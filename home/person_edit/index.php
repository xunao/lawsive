      	...
      	<div id="pedit_box">
      		...
      		<form id="resum_form" method="post" enctype="multipart/form-data" action="edit.post.php">
      			...
      			<div class="e_resume">
      				...
      				<div class="er_info">
      					<div class="er_i" id="er_add"><?php echo $i+1;?>#：自<font><?php echo $edu[$i]->start_date; ?></font>至<font><?php echo $edu[$i]->end_date; ?></font>在<font><?php echo $edu[$i]->college; ?></font>学习</div>
      				...
      				<div class="er_info">
      					<div class="er_i" id="er_add"><?php echo $i+1;?>#：自<font><?php echo $job[$i]->start_date; ?></font>至<font><?php echo $job[$i]->end_date; ?></font>在<font><?php echo $job[$i]->company; ?></font>担任<font><?php echo $job[$i]->title; ?></font></div>
