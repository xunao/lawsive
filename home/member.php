	      	 ...
	      	 <div id="person_index_center">
	      	 	<div id="info">
	      	 	    <div>
		      	 		...
		      	 		<div id="name"><?php echo $record[0]->name?><span style="font-size:12px; font-weight: normal; color: gray;">(<?php echo $record[0]->role_name();?>)</span>&nbsp;<a href="./mood/index.php?u_id=<?php echo $mood[0]->u_id?>" color="#666666"><?php echo $mood[0]->content?></a></div>
	                    <div id="from">
		      	 			<?php 
