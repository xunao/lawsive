      	...
      	<div id="main_container">
	      	 <div id="person_index_center">
	      	 	<div id="info">
	      	 		...
	      	 		<div id="name"><?php echo $info->name;?><span style="font-size:12px; font-weight: normal; color: gray;">(<?php echo $user->role_name();?>)</span>&nbsp;<font ><?php echo $record[0]->content?>  &nbsp; <?php echo date("Y-m-d",strtotime($record[0]->created_at));?></font></div>
	      	 		<div id="state">
