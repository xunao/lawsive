      	...
      	<div id="main_container">
	      	 <div id="person_index_center">
	      	 	<div id="info">
	      	 		...
	      	 		<div id="name"><?php echo $f_member[0]->name;?><span style="font-size:12px; font-weight: normal; color: gray;">(<?php echo $f_member[0]->role_name();?>)</span>&nbsp;<font color="#666666" size="2"><?php echo $record[0]->content?></font></div>
	      	 		<div id="from">
	      	 			<?php 
